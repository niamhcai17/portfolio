...
const mobilePetals = [
  { pctTop: 3, pctLeft: 75, rx: 12, ry: 8, rotate: -20, fill: "#EAAFAF", opacity: 0.6 },
  { pctTop: 8, pctLeft: 88, rx: 9, ry: 6, rotate: 15, fill: "#F2C6C6", opacity: 0.55 },
  { pctTop: 6, pctLeft: 10, rx: 8, ry: 5.5, rotate: 40, fill: "#D4A0A0", opacity: 0.45 },
  { pctTop: 14, pctLeft: 90, rx: 11, ry: 7, rotate: -35, fill: "#E8B4B4", opacity: 0.55 },
  { pctTop: 20, pctLeft: 3, rx: 10, ry: 7, rotate: 25, fill: "#F2C6C6", opacity: 0.4 },
  { pctTop: 26, pctLeft: 82, rx: 13, ry: 9, rotate: -10, fill: "#EAAFAF", opacity: 0.6 },
  { pctTop: 32, pctLeft: 15, rx: 8, ry: 5.5, rotate: -45, fill: "#D4A0A0", opacity: 0.38 },
  { pctTop: 38, pctLeft: 70, rx: 10, ry: 7, rotate: 30, fill: "#E8B4B4", opacity: 0.5 },
  { pctTop: 44, pctLeft: 5, rx: 9, ry: 6, rotate: -28, fill: "#F2C6C6", opacity: 0.42 },
  { pctTop: 50, pctLeft: 88, rx: 11, ry: 7.5, rotate: 18, fill: "#EAAFAF", opacity: 0.55 },
  { pctTop: 56, pctLeft: 35, rx: 8, ry: 5.5, rotate: -50, fill: "#D4A0A0", opacity: 0.4 },
  { pctTop: 62, pctLeft: 85, rx: 12, ry: 8, rotate: 12, fill: "#E8B4B4", opacity: 0.5 },
  { pctTop: 68, pctLeft: 8, rx: 10, ry: 7, rotate: -22, fill: "#F2C6C6", opacity: 0.45 },
  { pctTop: 74, pctLeft: 60, rx: 9, ry: 6, rotate: 38, fill: "#EAAFAF", opacity: 0.48 },
  { pctTop: 80, pctLeft: 25, rx: 11, ry: 7, rotate: -15, fill: "#D4A0A0", opacity: 0.5 },
  { pctTop: 86, pctLeft: 78, rx: 13, ry: 9, rotate: 45, fill: "#E8B4B4", opacity: 0.55 },
  { pctTop: 11, pctLeft: 48, rx: 7, ry: 5, rotate: 55, fill: "#F2C6C6", opacity: 0.35 },
  { pctTop: 42, pctLeft: 92, rx: 9, ry: 6, rotate: -8, fill: "#EAAFAF", opacity: 0.5 },
];
