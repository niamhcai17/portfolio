...
export default function Course() {
  return (
    <div className="flex flex-col min-h-screen overflow-x-hidden">
      ...
      {/* Chapter cards */}
      <section className="flex flex-wrap gap-6 px-6 lg:px-[120px] pt-4 lg:pt-8 pb-8">
        {chapters.map((chapter) => (
          <Link
            key={chapter.slug}
            href={`/course/chapters/${chapter.slug}`}
            className="flex flex-col gap-6 w-full sm:w-[386px] rounded-xl bg-card p-6 pb-5 lg:p-7 group hover:shadow-lg transition-shadow"
          >
